...
def raw_dataframe(test_path_or_df, infer_path_or_df):
  ...
  magic_df = data_preprocess.sub_handle("F:/project/simulation_data/drop60_p_magic.csv", way="row_normal",ind_col=0, trans=True)
  whole_df = data_preprocess.sub_handle("F:/project/simulation_data/simulation60_whole_p.csv", way="row_normal", ind_col=0, trans=True)
  scimpute_df = data_preprocess.sub_handle("F:/sc_new/imputation_data/scimpute_count.csv", way="row_normal", ind_col=0, trans=True)
